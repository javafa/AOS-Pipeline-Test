pipeline {
    ...
    stage('Deploy') {
      ...
      post {
        success {
          ...
          mail to: 'kodonho@mathflat.com', subject: 'New build available!', body: 'Check it out!'
        }
      }
    }
  }
  post {
    failure {
      ...
      mail to: 'kodonho@mathflat.com', subject: 'Oops!', body: "Build ${env.BUILD_NUMBER} failed; ${env.BUILD_URL}"
    }
  }
}